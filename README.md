...
HYAKVNC_APPTAINER_CONTAINER: Path to container image to use (REQUIRED)
...
HYAKVNC_APPTAINER_WRITABLE_TMPFS: Whether to use a writable tmpfs for the container (default: yes)
HYAKVNC_APPTAINER_CLEANENV: Whether to use a clean environment for the container (default: yes)
